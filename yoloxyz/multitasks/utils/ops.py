...
# from multitasks.utils.loss import bbox_iou_deyo
from multitasks.utils.general import xywh2xyxy, xyxy2xywh, bbox_iou_deyo
import numpy as np
...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, pred_bboxes, pred_scores, gt_bboxes, gt_cls, gt_groups, masks=None, gt_mask=None):
        ...
        cost_giou = 1.0 - bbox_iou_deyo(pred_bboxes.unsqueeze(1), gt_bboxes.unsqueeze(0), xywh=True, GIoU=True).squeeze(-1)
        # Final cost matrix
        C = (
